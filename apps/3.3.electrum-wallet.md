...
### Desktop file
If we want to have the application icon in the machine search bar or in the naviagation bar we need to create a desktop file. Get the [[electrum.desktop | desktop]] file and the [[electrum.icon.png | icon]]
```bash
